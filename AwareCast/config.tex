...
\def\plaintitle{Passenger prediction in metro stations: Analysis of passenger data from security cameras}
%\def\plainauthor{Andreas Jahn, Stephan Sigg}
\def\plainkeywords{subway, passenger density, CCTV cameras, prediction, Adaptive Network-based Fuzzy Inference System}
...
\hypersetup{
	...
	pdfkeywords={subway, count of passenger, metro station, CCTV cameras, prediction, predictive controlling},
	pdfsubject={\plaintitle},
...
%-- penalties --------------------------------------------------------------------------------
\renewcommand{\floatpagefraction}{20.0}
