...
\def\plaintitle{Prediction of passenger density in metro stations: Analysis of data from security cameras}
...
\hypersetup{
	...
	pdfkeywords={subway, passenger density, CCTV cameras, prediction, predictive controlling},
