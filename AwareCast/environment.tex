...
\begin{figure}%[htbp]
  \begin{center}
  \includegraphics[width=\marginparwidth]{Figures/PdG-L3_platform.jpg} 
...
\begin{figure}%[htbp]
  ...
  \caption{PdG-L3 Schematic~\cite{TMB_2014}}
...
\begin{figure}%[htbp]
  ...
  \subfigure[Camera in a PdG transit area. \cite{TMB_2014}] {
    \includegraphics[width=\marginparwidth]{Figures/PdG-L3_CCTVcamera_transitArea.jpg}
    \label{fig:PdG-L3_CCTVcamera_transitArea}
  }
  \hfill
  \subfigure[Camera in PdG-L3 platform. \cite{TMB_2014}] {
    \includegraphics[width=\marginparwidth]{Figures/PdG-L3_CCTVcamera_platform.jpg}
...
\begin{figure}%[htbp]
  \begin{center}
  \includegraphics[height=\marginparwidth,angle=90]{Figures/imageProcessing.pdf} 
